    ...
    'data': <String, dynamic>{
      'schemes': <Map<String, dynamic>>[
        ...
        <String, dynamic>{
          ...
          'bannerImageUrl': 'assets/banner_dhanvarsha.jpg',
          'isPopular': false,
        },
        <String, dynamic>{
          ...
          'bannerImageUrl': 'assets/banner_express.jpg',
          'isPopular': false,
        },
      ],
    },
    ...
    'data': <String, dynamic>{
      'offers': <Map<String, dynamic>>[
        <String, dynamic>{
          ...
          'imageUrl': 'assets/offers_diwali.jpg',
        },
        <String, dynamic>{
          'id': 'off_making_25',
          ...
          'imageUrl': 'assets/offers_making.jpg',
        },
      ],
    },
  };
    ...
    'data': <String, dynamic>{
      ...
      'products': <Map<String, dynamic>>[
        <String, dynamic>{
          ...
          'imageUrl': 'assets/product_necklace_01.jpg',
          'isNew': true,
        },
        <String, dynamic>{
          'id': 'prod_ring_02',
          ...
          'imageUrl': 'assets/product_ring_02.jpg',
          'isNew': false,
        },
        <String, dynamic>{
          'id': 'prod_bangles_03',
          ...
          'imageUrl': 'assets/product_bangles_03.jpg',
          'isNew': true,
        },
      ],
    },
